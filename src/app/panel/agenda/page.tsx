...
import { resolvePendingBookingApproval } from "@/app/panel/agenda/actions";
...
export default async function AgendaPage({ searchParams }: AgendaPageProps) {
  const [{ organizationId, organizationName, role }, filters] =
  ...
  const canManageBookings = role !== "staff";
      ...
      <section aria-labelledby="agenda-title" className="locations-shell">
        <header className="locations-header">
          <div>
            ...
            <h1 id="agenda-title">Disponibilidad de {organizationName}</h1>
          </div>
          <p>
                  ...
                  <li key={booking.id}>
                    ...
                    {canManageBookings ? (
                      <BookingApprovalActions
                        action={resolvePendingBookingApproval}
        ...
        {selectedLocation && servicesForLocation.length ? (
          ...
          <section className="availability-blocked">
            ...
            <Link className="button button-primary" href="/panel/servicios">
