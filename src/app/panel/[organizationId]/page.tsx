      ...
      <section aria-labelledby="workspace-title" className="workspace-shell">
        <header className="workspace-header">
          <div>
            ...
            <h1 id="workspace-title">{organizationResult.data.name}</h1>
          </div>
          <div className="workspace-meta">
            <span>{roleLabel}</span>
            <Link href="/panel">Cambiar negocio</Link>
          </div>
        </header>
        ...
        <ol className="workspace-steps">
          ...
          <li>
            ...
            <div>
              ...
              <Link
                className="workspace-step-action"
                href={`/panel/${organizationId}/agenda`}
              >
          ...
          <li>
            ...
            <div>
              ...
              <Link
                className="workspace-step-action"
                href={`/panel/${organizationId}/reservas-publicas`}
              >
