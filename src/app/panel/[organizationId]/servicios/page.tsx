...
import { createService } from "@/app/panel/[organizationId]/servicios/actions";
...
export default async function ServicesPage({ params }: ServicesPageProps) {
  ...
  const action = createService.bind(null, organizationId);
        ...
        <header className="locations-header">
          <div>
            ...
            <h1 id="services-title">
              Servicios de {organizationResult.data.name}
            </h1>
          </div>
          <p>
            ...
            {servicesResult.data.length ? (
              <>
                ...
                <Link
                  ...
                  href={`/panel/${organizationId}/disponibilidad`}
                >
          ...
          <aside className="locations-form-panel">
            {canManage && activeResources.length ? (
              <>
                ...
                <ServiceForm action={action} resources={activeResources} />
              </>
            ) : canManage ? (
