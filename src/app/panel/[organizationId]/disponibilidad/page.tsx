...
} from "@/app/panel/[organizationId]/disponibilidad/actions";
...
export default async function AvailabilityPage({
  ...
  const [
    ...
    supabase
      ...
      .select("id, location_id, resource_id, day_of_week, start_time, end_time")
      .eq("tenant_id", organizationId)
      .eq("is_active", true)
      .order("day_of_week")
      .order("start_time"),
  ...
  const ruleAction = createAvailabilityRule.bind(null, organizationId);
  const exceptionAction = createAvailabilityException.bind(
    null,
    organizationId,
  );
